...
def plot_prediction_map(
    ...
    #cb.set_ticks()
    cb.set_label('SWE value (in)', fontsize=24, fontweight='bold')
...
def plot_scatter(
    ...
    plt.xlabel('Observation (in)', fontsize=24)
    plt.ylabel(f'Model: {model_name} (in)', fontsize=24)
...
def plot_rmse_r2_swe(
    ...
    cs = plt.scatter(rmse, r2, c=swe, s=30, cmap='turbo', vmin=0, vmax=20, alpha=0.8)
    ...
    cb = plt.colorbar(cs, extend='max')
    cb.set_label('Average SWE (inch)', fontsize=24)
    cb.outline.set_linewidth(3)
    cb.ax.tick_params(labelsize=24)
...
def plot_avg_swe_map(
    ...
    cs = plt.scatter(lon, lat, c=swe, s=100, marker='.', cmap='turbo', vmin=0, vmax=20)
    ...
    cb   = plt.colorbar(cs, extend='max', orientation='vertical', cax=cbax)
    #cb.set_ticks()
    cb.set_label('SWE (in)', fontsize=24, fontweight='bold')
    cb.outline.set_linewidth(3)
    cb.ax.tick_params(labelsize=24)
...
def plot_model_scatter(
    ...
    plt.xlabel('Observation (in)', fontsize=24)
    plt.ylabel(f'{prod_option} Model (in)', fontsize=24)
    plt.xlim([0, tick_limit])
    plt.ylim([0, tick_limit])
    plt.grid(True, axis='y')
